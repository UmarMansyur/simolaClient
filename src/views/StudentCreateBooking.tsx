...
export default function Sent() {
  ...
  const [filter, setFilter] = useState<string>("?status=Menunggu Persetujuan&nomor_induk=" + user.id);
  const {
    startNumber,
    result,
    totalData,
              ...
              >
                <li className="nav-item" role="presentation">
                  <a
                    ...
                    aria-selected="true"
                    onClick={() => {
                      setFilter("?status=Menunggu Persetujuan&nomor_induk=" + user.id);
                      setQuery("");
                    }}
                  >
                ...
                <li className="nav-item" role="presentation">
                  <a
                    ...
                    tabIndex={-1}
                    onClick={() => {
                      setFilter("?status=sudah&nomor_induk=" + user.id);
                      setQuery("");
                    }}
                  >
                    <span className="d-block d-sm-none">
